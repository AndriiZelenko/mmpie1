...
def pil_to_ascii(image: Image) -> str:
    ...
    Example::
          ...
          import PIL
          from mmpie1.utils import pil_to_ascii, ascii_to_pil
...
def pil_to_bytes(image: Image) -> bytes:
    ...
    Example::
          ...
          import PIL
          from mmpie1.utils import pil_to_bytes, bytes_to_pil
...
def pil_to_tensor(image: Image) -> torch.Tensor:
    ...
    Example:
        ...
        from mmpie1.utils import pil_to_tensor
...
def tensor_to_pil(image: torch.Tensor, mode=None, min_val=None, max_val=None) -> Image:
    ...
    Example::
        from PIL import Image
        from mmpie1.utils import pil_to_tensor, tensor_to_pil
...
def ndarray_to_pil(image: np.ndarray, image_format: str = "RGB"):
    ...
    Example::
        ...
        from mmpie1.utils import ndarray_to_pil
...
def pil_to_cv2(image: Image) -> np.ndarray:
    ...
    Example::
          ...
          import PIL
          from mmpie1.utils import pil_to_cv2
...
def cv2_to_pil(image: np.ndarray) -> Image:
    ...
    Example::
          ...
          import cv2
          from mmpie1.utils import cv2_to_pil
