"""Mmpie1Base class. Provides unified configuration, logging and context management."""
import logging
...
class Mmpie1Base:
    """Base class for all Mmpie1 core classes.

    The Mmpie1Base class adds default context manager and logging methods. All classes that derive from
    Mmpie1Base can be used as context managers and will use a unified logging format.
    """
