"""Client-side helper class for communicating with the Mmpie1 gateway server."""
import json
...
from mmpie1.utils import ascii_to_pil, pil_to_ascii


class ConnectionClient:
    """Client-side helper class for communicating with the Mmpie1 deployment server."""
